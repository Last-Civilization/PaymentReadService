...
import com.lastcivilization.paymentreadservice.infrastructure.application.PaymentReadServiceApplication;
...
@SpringBootTest(classes = PaymentReadServiceApplication.class, webEnvironment = RANDOM_PORT)
@Testcontainers
